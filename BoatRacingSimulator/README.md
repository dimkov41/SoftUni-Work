...
**CreateBoatEngine** tries to make a new boat engine of the specified
...
**Values** will consist only of **Latin letters** and **numbers**. The
...
Model the system and all entities using the best established practices
